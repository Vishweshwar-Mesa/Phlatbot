...
export default async function ConstraintsPage({ params }: PageProps<"/p/[token]/constraints">) {
    ...
    <>
      ...
      <main className="container">
        {me.form_submitted_at && (
          <p className="success small" style={{ marginTop: 0 }}>
            ✓ Submitted. Change anything and tap Update. Unpublished listings get re-scored straight away.
          </p>
        )}
